...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        layout.addLayout(button_layout, 0, 0, 3, 1)
        ...
        self.table_stock.setMinimumSize(500, 200)
        ...
        self.changed_table_stock.setMinimumSize(500, 200)
        ...
        self.table_failure.setMinimumSize(500, 200)
        ...
        self.table_success.setMinimumSize(500, 200)
        ...
        layout.addWidget(self.plot_frame, 3, 0, 3, 1)
    ...
    def display_data_in_table(self, data, table):
        ...
        table.resizeColumnsToContents()  # Automatyczne dopasowanie szerokości kolumn
